...
class SQLSaldoNegativo(ProcLog):
    
    def proc_saldo_negativo(self, path_run, trat=None):
    ...
    def __get_path(self, path_run):
        with open(os.path.join(path_run, 'path.json'), 'r') as f:
            ...
            self.path = os.path.join(path_data['path'].format(login=os.getlogin()), 'saldo_negativo')
